...
export const Sidebar = () => {
  ...
  //location route ko store karne ke liye
  ...
  const SidebarContent = (
    <>
      ...
      {!isMobile && <div className='flex-grow'/>}
        ...
        <Link to='/settings' className={`${isMobile ? "" : "mb-8"} ${activeTab === 'setting' && "bg-gray-300 shadow-sm p-2 rounded-full"} focus:outline-none`}>
        <FaCog
          className={`h-6 w-6 ${activeTab === 'status' ? theme === 'dark' ? "text-gray-800" : "" : theme === 'dark' ? "text-gray-300" : "text-gray-800"}`}
        />
      </Link>
